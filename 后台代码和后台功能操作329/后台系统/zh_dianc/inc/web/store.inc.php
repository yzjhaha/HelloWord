...
$sql="select a.*,b.type_name,c.area_name from " . tablename("wpdc_store") . " a"  . " left join " . tablename("wpdc_storetype") . " b on b.id=a.md_type " . " left join " . tablename("wpdc_area") . " c on c.id=a.md_area ".$where;
