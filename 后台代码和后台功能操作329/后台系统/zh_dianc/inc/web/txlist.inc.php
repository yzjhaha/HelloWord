...
if($type=='all'){    
  $sql="SELECT a.*,b.md_name FROM ".tablename('wpdc_withdrawal') .  " a"  . " left join " . tablename("wpdc_store") . " b on a.store_id=b.id ". $where." ORDER BY a.time DESC";
...
if($operation=='reject'){
     $id=$_GPC['id'];
    $res=pdo_update('wpdc_withdrawal',array('state'=>3),array('id'=>$id));
     if($res){
